...
moveAction.performed -= OnMove; // This listens for when the player presses
//a movement key like a or d
moveAction.canceled -= OnMoveCancelled; 
// This listens for when the player
//releases the key
moveAction.Disable(); 
// It turns off the input action - Unity will stop
//listening for that specific input. Improves performance by stopping unnecessary
//input checks.
}
...
Vector2 movement = new Vector2(moveInput.x, 0) * moveSpeed *
Time.deltaTime;
